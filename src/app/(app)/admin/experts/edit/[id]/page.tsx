...
const EditExpertPage = () => {
  ...
  const loadExpert = async (id: string) => {
    ...
    try {
      const result = await CEPROFExpertsService.getExpertById(id)
      if (result.success && result.data) {
        ...
        setFormData({
          ...
          practice_location: expert.practice_location || '',
          website: expert.website || '',
          linkedin: expert.linkedin || '',
          is_active: expert.is_active,
          is_instructor: expert.is_instructor,
          is_verified: expert.is_verified,
          joined_date: expert.joined_date.split('T')[0]
        })
      } else {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true)
    try {
      const result = await CEPROFExpertsService.updateExpert(params.id as string, formData)
      if (result.success) {
          ...
          <AdminLayout currentPage="experts">
            <div className="flex justify-center items-center min-h-[400px]">
              <div className="text-center">
                ...
                <p className="mt-2 text-sm text-gray-500">Chargement de l'expert...</p>
              </div>
            </div>
          </AdminLayout>
        </ProtectedRoute>
  ...
  return (
    <AuthProvider>
      <ProtectedRoute>
        <AdminLayout currentPage="experts">
          <div className="nc-EditExpertPage">
