...
const casCliniques = [
  {
    ...
    date: "Mars 2024",
    images: {
      before: "/images/formation-default.svg",
      after: "/images/formation-default.svg"
    },
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              Cas <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Cliniques</span>
            </h1>
