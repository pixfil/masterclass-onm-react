...
function HomePage() {
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 lg:py-28 bg-white dark:bg-neutral-900">
        <div className="container">
          <div className="text-center mb-16">
            <span className="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold bg-gradient-to-r from-blue-600/10 to-cyan-500/10 text-blue-600 dark:text-blue-400 border border-blue-500/20 mb-6">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-neutral-900 dark:text-white mb-6">
              Outils hybrides et traitements <span className="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">interdisciplinaires</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="text-center p-8 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/10 dark:to-cyan-900/10 rounded-2xl border border-blue-100 dark:border-blue-800/30">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-blue-600 to-cyan-500 rounded-3xl p-8 text-white">
                <div className="text-center mb-6">
                  <AcademicCapIcon className="w-16 h-16 mx-auto mb-4 text-blue-200" />
                  <h4 className="text-2xl font-bold mb-2">Dr. Romain de Papé</h4>
                  <p className="text-blue-200">Fondateur de la méthode ONM</p>
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-3xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-start justify-between mb-6">
                <div>
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 mb-3">
                    Module 01
                  </span>
      ...
      {/* Section CTA finale */}
      <section className="py-20 lg:py-28 bg-gradient-to-r from-blue-600 to-cyan-500">
        <div className="container">
