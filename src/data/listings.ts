...
// Images supprimées car non utilisées dans la version Real Estate
  ...
  return [
    {
      ...
      featuredImage: '/images/hero-right-real-estate.png',
      galleryImgs: [],
