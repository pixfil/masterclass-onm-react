...
import { getCleanImageSrc } from '@/utils/imageUtils'
...
export default function GallerySlider({
  ...
  const imageSrc = getCleanImageSrc(currentImage)
  
  // Ne pas rendre le composant si aucune image valide
  if (!imageSrc || !images.length) {
    return (
      <div className={clsx(`group/cardGallerySlider group relative`, className)}>
        <div className={clsx(`w-full overflow-hidden rounded-xl bg-neutral-200 dark:bg-neutral-700`, galleryClass)}>
