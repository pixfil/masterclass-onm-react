    ...
    <div className={className}>
      ...
      <div className="relative">
        <input
          ...
          required={required}
          className="w-full px-3 py-2 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-neutral-700 dark:border-neutral-600 dark:text-white placeholder-neutral-400 dark:placeholder-neutral-500"
        />
        {isFocused && (
