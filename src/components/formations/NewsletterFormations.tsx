...
const NewsletterFormations = () => {
  ...
  return (
    <div className="nc-NewsletterFormations relative py-16">
      <div className="relative bg-primary-50 dark:bg-primary-900/10 rounded-3xl p-8 lg:p-16">
        <div className="max-w-2xl mx-auto text-center">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-primary-100 dark:bg-primary-800/30 rounded-full mb-6">
          ...
          <form onSubmit={handleSubmit} className="max-w-md mx-auto">
            <div className="relative">
              <input
                ...
                required
                className="w-full px-6 py-4 pr-36 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 focus:outline-none focus:border-primary-500 transition-colors"
              />
              <ButtonPrimary
                type="submit"
                loading={loading}
